...
@section('content')
    <div class="container mx-auto p-4">
        <div class="flex flex-col">
            ...
            <form action="{{ isset($page) ? route('custom-page.update', $page->id) : route('custom-page.store') }}" enctype="multipart/form-data" method="post">
                @csrf
                @if(isset($page))
                    @method('PUT')
                @endif
                <div class="form-group">
                    ...
                    <a href="{{ isset($page) ? route('pages', $page->url) : '' }}" target="_blank" class="text-blue-500 mb-4">View Page</a>
                    ...
                    @if(isset($page->blocks))
                        @foreach($page->blocks as $block)
                            ...
                            <div class="block-fields" data-block-type="{{$block->type}}" style="display: none;">
                                ...
                                <x-forms.input-textarea name="{{$block->type}}_text">{{$block->text}}</x-forms.input-textarea>
