<div wire:key="advertisement-{{ $advertisement->id }}" class="bg-white shadow-md rounded overflow-hidden mb-4 relative">
    ...
    <div class="px-8 pt-6 pb-8 text-center">
        ...
        <div class="w-full">
            <button class="block w-full bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">View Details</button>
        </div>
    </div>
    </a>
</div>
