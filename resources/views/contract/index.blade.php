    ...
    <div class="container mx-auto p-4 min-h-[calc(100vh-50px-75px)]">
        <div class="flex flex-wrap">
            ...
            <div class="w-full md:w-3/4 p-4">
                ...
                <a href="{{ route('contracts.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mb-4 inline-block">Create contract</a>
                    ...
                    <a href="{{route('contracts.show', ['id' => $contract->id])}}" class="block mb-4">
                        <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex items-center">
                            ...
                            <div class="w-1/4 text-right">
                                <a href="{{ route('contracts.download', ['id' => $contract->id]) }}" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">Download</a>
                            </div>
                        </div>
                    </a>
                @endforeach
